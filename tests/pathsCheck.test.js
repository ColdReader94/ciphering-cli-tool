...
describe('Provided paths check', () => {
  ...
  it('should throw repeated arguments error', () => {
    ...
    }).toThrowError('Arguments must not repeat!');
  });
  ...
  it('should throw wrong input path error', () => {
    ...
    }).toThrowError("ENOENT: no such file or directory, stat 'sdfdsfs.txt'");
  });
  ...
  it('should throw wrong output path error', () => {
    ...
    }).toThrowError("ENOENT: no such file or directory, stat 'dfsasfdaf.txt'");
  });
  ...
  it('should execute ok', () => {
    ...
    expect(mockConsoleOutput()).toBe(0);
  });
});
